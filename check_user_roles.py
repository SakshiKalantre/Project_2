...
try:
    ...
    for column in columns:
        print(f"{column[0]:<20} {column[1]:<15} {column[2]:<10} {str(column[3]):<20}")
    ...
    # Check the constraints on the role column
    print("\n" + "=" * 80)
    print("Checking constraints on the role column:")
    print("=" * 80)
    ...
    if constraints:
        ...
        print("No specific constraints found on the role column.")
